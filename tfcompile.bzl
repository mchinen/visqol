"""This file was created from:
  https://github.com/tensorflow/tensorflow/blob/v2.6.0/tensorflow/compiler/aot/tfcompile.bzl
It is needed to use tfcompile in an external repo because the original (local)
TF deps are not transitive beacuse bazel does not implement recursive workspaces.
This file modifies the local TF dependencies to include the external tf dep
syntax, e.g. '//some/target/in/tf' -> '@org_tensorflow//some/target/in/tf'.
The rest of the file is unaltered.
...
load("@org_tensorflow//tensorflow:tensorflow.bzl", "tfcompile_target_cpu")
...
def tf_library(
    ...
    if freeze_checkpoint or freeze_saver:
        ...
        native.genrule(
            ...
            cmd = (
                ...
                "$(location " +
                "@org_tensorflow//tensorflow/python/tools:freeze_graph)" +
                freeze_args
            ),
    ...
    native.cc_library(
        ...
        deps = [
            ...
            "@org_tensorflow//tensorflow/compiler/xla/service:hlo_profile_printer_data_cc",
    ...
    if gen_test:
        ...
        # @org_tensorflow//tensorflow/core:lib -- see the note in
...
def target_llvm_triple():
    ...
    return select({
        ...
        "@org_tensorflow//tensorflow:ios": "arm64-none-ios",
        "@org_tensorflow//tensorflow:ios_x86_64": "x86_64-apple-ios",
        "@org_tensorflow//tensorflow:linux_ppc64le": "ppc64le-ibm-linux-gnu",
        "@org_tensorflow//tensorflow:macos_x86_64": "x86_64-none-darwin",
        "@org_tensorflow//tensorflow:macos_arm64": "aarch64-none-darwin",
        "@org_tensorflow//tensorflow:windows": "x86_64-none-windows",
        "@org_tensorflow//tensorflow:linux_s390x": "systemz-none-linux-gnu",
